...
#define PLUGIN_ID "2F37B16F-5130-460C-86E6-1F099A5550B6"
...
HRESULT QuickLookGeneratorQueryInterface(void *thisInstance, REFIID iid,
                                         LPVOID *ppv);
...
AllocQuickLookGeneratorPluginType(CFUUIDRef inFactoryID) {
   ...
   * filler from myInterfaceFtbl over */
  theNewInstance->conduitInterface = malloc(sizeof(QLGeneratorInterfaceStruct));
  memcpy(theNewInstance->conduitInterface, &myInterfaceFtbl,
